...
public class GlobalExceptionHandler  {
    ...
    public ResponseEntity<Map<String, Object>> handleCredenciales(
    ...
    public ResponseEntity<Map<String, Object>> handleValidacion(
        ...
        log.error("Error de validación en ms-auth");
    ...
    public ResponseEntity<Map<String, Object>> handleRuntime(RuntimeException ex) {
        log.error("Error de negocio en ms-auth: {}", ex.getMessage());
    ...
    public ResponseEntity<Map<String, Object>> handleGenerico(Exception ex) {
        log.error("Error inesperado en ms-auth: {}", ex.getMessage());
