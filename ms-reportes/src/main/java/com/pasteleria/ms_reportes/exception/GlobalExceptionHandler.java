package com.pasteleria.ms_reportes.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleValidacion(
        ...
        log.error("Error de validación en ms-reportes");
    ...
    public ResponseEntity<Map<String, Object>> handleRuntime(
            RuntimeException ex) {
        log.error("Error en ms-reportes: {}", ex.getMessage());
    ...
    public ResponseEntity<Map<String, Object>> handleGenerico(
            Exception ex) {
        log.error("Error inesperado en ms-reportes: {}",
                ex.getMessage());
