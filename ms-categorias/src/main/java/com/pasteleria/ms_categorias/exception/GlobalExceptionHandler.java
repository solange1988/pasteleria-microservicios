...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleValidacion(
        ...
        log.error("Error de validación en ms-categorias");
    ...
    public ResponseEntity<Map<String, Object>> handleRuntime(
            RuntimeException ex) {
        log.error("Error de negocio en ms-categorias: {}", ex.getMessage());
    ...
    public ResponseEntity<Map<String, Object>> handleGenerico(Exception ex) {
        log.error("Error inesperado en ms-categorias: {}", ex.getMessage());
