package com.pasteleria.ms_usuarios.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleValidacion(
        ...
        log.error("Error de validación en ms-usuarios");
    ...
    public ResponseEntity<Map<String, Object>> handleRuntime(
            RuntimeException ex) {
        log.error("Error de negocio en ms-usuarios: {}", ex.getMessage());
    ...
    public ResponseEntity<Map<String, Object>> handleGenerico(Exception ex) {
        log.error("Error inesperado en ms-usuarios: {}", ex.getMessage());
