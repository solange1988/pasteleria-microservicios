...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handlePagoInvalido(
            PagoInvalidoException ex) {
        log.error("Pago inválido: {}", ex.getMessage());
    ...
    public ResponseEntity<Map<String, Object>> handleValidacion(
        ...
        log.error("Error de validación en ms-pagos");
    ...
    public ResponseEntity<Map<String, Object>> handleRuntime(
            RuntimeException ex) {
        log.error("Error de negocio en ms-pagos: {}",
                ex.getMessage());
    ...
    public ResponseEntity<Map<String, Object>> handleGenerico(
            Exception ex) {
        log.error("Error inesperado en ms-pagos: {}",
                ex.getMessage());
