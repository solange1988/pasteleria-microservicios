package com.pasteleria.ms_notificaciones.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleValidacion(
        ...
        log.error("Error de validación en ms-notificaciones");
    ...
    public ResponseEntity<Map<String, Object>> handleRuntime(
            RuntimeException ex) {
        log.error("Error de negocio en ms-notificaciones: {}",
                ex.getMessage());
    ...
    public ResponseEntity<Map<String, Object>> handleGenerico(
            Exception ex) {
        log.error("Error inesperado en ms-notificaciones: {}",
                ex.getMessage());
